...
angular
    ...
    .module('app.novocard', ['angularFileUpload'])


    .controller('NovoCardCtrl', ['$scope', 'FileUploader','$http','$ionicModal', '$timeout', '$stateParams','$location', function($scope, FileUploader,$http, $ionicModal, $timeout, $stateParams,$location) {
  ...
  namespace = $stateParams.namespace;
      ...
      $scope.novoCard = function (card){
        if($scope.combate.cards != null){
         $scope.combate.cards.push(card);
        }else{
          $scope.combate.cards = [];
          $scope.combate.cards.push(card);
        }; 
