...
angular
  ...
  .module('app.tarefa', ['angularFileUpload'])

  .controller('TarefaCtrl',  ['$scope', 'FileUploader','$http','$ionicModal', '$timeout', '$stateParams','$location', function($scope, FileUploader,$http, $ionicModal, $timeout, $stateParams,$location) {
    ...
    id = $stateParams.id;
    if($stateParams.idtarefa !=null){
      idtarefa = $stateParams.idtarefa;
      console.info('id da tarefa', $stateParams.idtarefa);
    }
