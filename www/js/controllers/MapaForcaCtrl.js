...
angular
    ...
    .module('app.mapaForca', ['angularFileUpload'])

    .controller('MapaForcaCtrl', ['$scope', 'FileUploader','$http','$ionicModal', '$timeout', '$stateParams','$location','$log','$templateCache','combatesAPI','dadoAPI','mapaForcaAPI', function($scope, FileUploader,$http, $ionicModal, $timeout, $stateParams,$location,$log,$templateCache,combatesAPI,dadoAPI,mapaForcaAPI) {
    ...
    carregarTarefa();  
      ...
      $scope.adicionarTarefa = function (tarefa){
        ...
        console.log($scope.combate.mapaForcas[$stateParams.id]);
