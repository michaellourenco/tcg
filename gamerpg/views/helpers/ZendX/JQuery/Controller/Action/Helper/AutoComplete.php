...
extends Zend_Controller_Action_Helper_AutoComplete_Abstract
{
    ...
    public function prepareAutoCompletion($data, $keepLayouts = false)
    {
        if (!$this->validateData($data)) {
            /**
             * @see Zend_Controller_Action_Exsabtion
             */
            require_once 'Zend/Controller/Action/Exsabtion.php';
            throw new Zend_Controller_Action_Exsabtion('Invalid data passed for autocompletion');
        }
